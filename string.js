...
var greatlenth = greet.length;
console.log("total no of character in given string is = ", greatlenth);

var charAtZeroIndex = greet.charAt(0);
console.log("char at o index ",charAtZeroIndex);
...
var gname ="Gajanan";
var namelenth = gname.length;
console.log("total no of character in given string is = ", namelenth);

//string madhe space hi count karte-
var gname ="Gajanan    ";
var namelenth = gname.length;
console.log("total no of character in given string is = ", namelenth);
